  ...
  return (
    <div>
      ...
      <div className="contenedor-categorias">
        ...
        <select name="cars" id="categorias" className="input-categorias form-select" onChange={() => select()}>
        ...
        products !== undefined ?
          products.map((product) => (
            <div className="list-container" onClick={() => goDetail(product.producto_id)} key={product.producto_id}>
              <Item price={product.precio || product.Precio} title={product.Titulo || product.titulo} retailer={product.proveedor_nombre || product.proveedor} picture={product.imagen || product.Image} brand={product.marca} />
            </div>
          ))
          :
